...
class PlatosControllerTest < ActionController::TestCase
  ...
  test "should create plato" do
    assert_difference('Plato.count') do
      post :create, plato: { descripcion: @plato.descripcion, nombre: @plato.nombre, porcion_completa: @plato.porcion_completa, precio: @plato.precio, tipo: @plato.tipo }
    end
  ...
  test "should update plato" do
    put :update, id: @plato, plato: { descripcion: @plato.descripcion, nombre: @plato.nombre, porcion_completa: @plato.porcion_completa, precio: @plato.precio, tipo: @plato.tipo }
    assert_redirected_to plato_path(assigns(:plato))
  end
